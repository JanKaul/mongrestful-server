...
export function databaseRoutes(dbName: string, dbOptions: DbOptions, client: Option<MongoClient>, app: Express) {
        ...
        const result = match(client)
            .with({ tag: "some" }, (x) => {
                ...
                try {
                    ...
                    collectionRoutes(dbName, dbOptions, collectionName as string, collectionOptions as CollectionOptions, x, app)
